...
if(USE_C10D_XCCL)
  ...
  target_link_libraries(torch_xpu_ops PUBLIC torch::xccl fmt::fmt-header-only)
endif()
...
foreach(lib ${TORCH_XPU_OPS_LIBRARIES})
  ...
  target_include_directories(${lib} PUBLIC ${TORCH_XPU_OPS_INCLUDE_DIRS} ${ATen_XPU_INCLUDE_DIRS} ${SYCL_INCLUDE_DIR})
  target_link_libraries(${lib} PUBLIC ${SYCL_LIBRARY} PRIVATE ATEN_XPU_OPS_FILES_GEN_LIB)
endforeach()
